...
screen = SDL_CreateRGBSurface(0,640,480,24, 0x00FF0000, 0x0000FF00, 0x000000FF, 0xFF000000);
if (screen == NULL) {
...
SDL_SetColorKey(ttext,SDL_RLEACCEL, SDL_MapRGB(ttext->format,255,0,0));
